#!/usr/bin/env python
"""Short GPT-NeoX performance baseline on fully materialized WikiText-103.

  python alien_ink/zdeck/baseline_perf_gpt-neox_mist.py
"""
...
RUN_NAME = "baseline-perf-gpt-neox-mist"
