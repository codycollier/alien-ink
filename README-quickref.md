...
```bash
python alien_ink/zdeck/pre_gpt-2_wikipedia_5k_mist.py      # GPT-2, 5k steps, Wikipedia stream
python alien_ink/zdeck/pre_gpt-2_wikitext_5k_mist.py       # GPT-2, 5k steps, WikiText stream
python -m alien_ink.zdeck.pre_gemma_c4_5k_mist            # Gemma (Mist-sized), 5k steps, C4 stream
...
Completions against a checkpoint: `./bin/model-chat-mist.py pre_gpt-2_wikitext_5k_mist`
